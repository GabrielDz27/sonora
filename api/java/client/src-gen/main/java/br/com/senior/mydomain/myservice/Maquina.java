...
public class Maquina extends CustomDTO {
    ...
    public static class PagedResults {
        ...
        public List<Maquina> contents;
        
        public PagedResults() {
        }
        
        public PagedResults(List<Maquina> contents) {
            this.contents = contents;
        }
        
        public PagedResults(List<Maquina> contents, Long totalPages, Long totalElements) {
            this.contents = contents;
     ...
     */
    public Maquina(String id, String nome, StatusMaquina status, List<JsonPatch> jsonPatches) {
        this.id = id;
        this.nome = nome;
        this.status = status;
     ...
     */
    public Maquina(String nome, StatusMaquina status) {
        this.nome = nome;
        this.status = status;
    }
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	MaquinaStringSerializer.INSTANCE.serialize(this, sb, appended);
    }
