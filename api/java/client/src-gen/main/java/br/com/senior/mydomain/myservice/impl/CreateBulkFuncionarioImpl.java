...
import br.com.senior.mydomain.myservice.CreateBulkFuncionarioInput;
import br.com.senior.mydomain.myservice.CreateBulkFuncionarioOutput;
...
public class CreateBulkFuncionarioImpl {
	...
	private Message createMessage(CreateBulkFuncionarioInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_BULK_FUNCIONARIO, //
	...
	* The 'createBulk' request primitive for the Funcionario entity.
	*/
	public CompletableFuture<CreateBulkFuncionarioOutput> createBulkFuncionarioRequest(CreateBulkFuncionarioInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkFuncionarioOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
