...
import br.com.senior.mydomain.myservice.CreateBulkMaquinaInput;
import br.com.senior.mydomain.myservice.CreateBulkMaquinaOutput;
 ...
 * 
 */
public class CreateBulkMaquinaImpl {
	...
	public CreateBulkMaquinaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkMaquinaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_BULK_MAQUINA, //
	...
	*/
	public CreateBulkMaquinaOutput createBulkMaquina(CreateBulkMaquinaInput input, long timeout) {
		...
		CreateBulkMaquinaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkMaquinaOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<CreateBulkMaquinaOutput> createBulkMaquinaRequest(CreateBulkMaquinaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkMaquinaOutput.class);
	}
	...
	* The 'createBulk' request primitive for the Maquina entity.
	*/
	public CompletableFuture<CreateBulkMaquinaOutput> createBulkMaquinaRequest(CreateBulkMaquinaInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkMaquinaOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
