...
import br.com.senior.mydomain.myservice.CreateBulkPecaInput;
import br.com.senior.mydomain.myservice.CreateBulkPecaOutput;
 ...
 * 
 */
public class CreateBulkPecaImpl {
	...
	public CreateBulkPecaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkPecaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_BULK_PECA, //
	...
	*/
	public CreateBulkPecaOutput createBulkPeca(CreateBulkPecaInput input, long timeout) {
		...
		CreateBulkPecaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkPecaOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<CreateBulkPecaOutput> createBulkPecaRequest(CreateBulkPecaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkPecaOutput.class);
	}
	...
	* The 'createBulk' request primitive for the Peca entity.
	*/
	public CompletableFuture<CreateBulkPecaOutput> createBulkPecaRequest(CreateBulkPecaInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkPecaOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
