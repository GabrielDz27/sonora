...
import br.com.senior.mydomain.myservice.CreateBulkRegistroProducaoInput;
import br.com.senior.mydomain.myservice.CreateBulkRegistroProducaoOutput;
 ...
 * 
 */
public class CreateBulkRegistroProducaoImpl {
	...
	public CreateBulkRegistroProducaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkRegistroProducaoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_BULK_REGISTRO_PRODUCAO, //
	...
	*/
	public CreateBulkRegistroProducaoOutput createBulkRegistroProducao(CreateBulkRegistroProducaoInput input, long timeout) {
		...
		CreateBulkRegistroProducaoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkRegistroProducaoOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<CreateBulkRegistroProducaoOutput> createBulkRegistroProducaoRequest(CreateBulkRegistroProducaoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkRegistroProducaoOutput.class);
	}
	...
	* The 'createBulk' request primitive for the RegistroProducao entity.
	*/
	public CompletableFuture<CreateBulkRegistroProducaoOutput> createBulkRegistroProducaoRequest(CreateBulkRegistroProducaoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkRegistroProducaoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
