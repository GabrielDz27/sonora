 ...
 * 
 */
public class CreateMaquinaImpl {
	...
	public CreateMaquinaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Maquina input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_MAQUINA, //
	...
	* The 'create' request primitive for the Maquina entity.
	*/
	public CompletableFuture<Maquina> createMaquinaRequest(Maquina input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
