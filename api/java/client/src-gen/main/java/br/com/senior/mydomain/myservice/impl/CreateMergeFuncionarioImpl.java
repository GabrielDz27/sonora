...
public class CreateMergeFuncionarioImpl {
	...
	private Message createMessage(Funcionario input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_MERGE_FUNCIONARIO, //
	...
	* The 'createMerge' request primitive for the Funcionario entity.
	*/
	public CompletableFuture<Funcionario> createMergeFuncionarioRequest(Funcionario input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
