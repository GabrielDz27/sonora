 ...
 * 
 */
public class CreateMergeMaquinaImpl {
	...
	public CreateMergeMaquinaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Maquina input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_MERGE_MAQUINA, //
	...
	* The 'createMerge' request primitive for the Maquina entity.
	*/
	public CompletableFuture<Maquina> createMergeMaquinaRequest(Maquina input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
