 ...
 * 
 */
public class CreateMergePecaImpl {
	...
	public CreateMergePecaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Peca input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_MERGE_PECA, //
	...
	* The 'createMerge' request primitive for the Peca entity.
	*/
	public CompletableFuture<Peca> createMergePecaRequest(Peca input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
