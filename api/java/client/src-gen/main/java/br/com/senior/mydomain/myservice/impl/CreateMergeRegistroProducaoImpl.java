 ...
 * 
 */
public class CreateMergeRegistroProducaoImpl {
	...
	public CreateMergeRegistroProducaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(RegistroProducao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_MERGE_REGISTRO_PRODUCAO, //
	...
	* The 'createMerge' request primitive for the RegistroProducao entity.
	*/
	public CompletableFuture<RegistroProducao> createMergeRegistroProducaoRequest(RegistroProducao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
