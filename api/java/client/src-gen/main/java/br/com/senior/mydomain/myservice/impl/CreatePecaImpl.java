...
public class CreatePecaImpl {
	...
	public CreatePecaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Peca input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_PECA, //
	...
	* The 'create' request primitive for the Peca entity.
	*/
	public CompletableFuture<Peca> createPecaRequest(Peca input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
