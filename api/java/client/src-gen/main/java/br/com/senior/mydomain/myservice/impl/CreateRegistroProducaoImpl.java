 ...
 * 
 */
public class CreateRegistroProducaoImpl {
	...
	public CreateRegistroProducaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(RegistroProducao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_REGISTRO_PRODUCAO, //
	...
	* The 'create' request primitive for the RegistroProducao entity.
	*/
	public CompletableFuture<RegistroProducao> createRegistroProducaoRequest(RegistroProducao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
