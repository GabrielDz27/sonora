 ...
 * 
 */
public class CreateRegistro_producaoImpl {
	...
	public CreateRegistro_producaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Registro_producao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_REGISTROPRODUCAO, //
	...
	* The 'create' request primitive for the Registro_producao entity.
	*/
	public CompletableFuture<Registro_producao> createRegistro_producaoRequest(Registro_producao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
