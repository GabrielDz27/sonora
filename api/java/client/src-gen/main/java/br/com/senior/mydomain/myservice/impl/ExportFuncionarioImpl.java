...
import br.com.senior.mydomain.myservice.ExportFuncionarioInput;
import br.com.senior.mydomain.myservice.ExportFuncionarioOutput;
...
public class ExportFuncionarioImpl {
	...
	private Message createMessage(ExportFuncionarioInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.EXPORT_FUNCIONARIO, //
	...
	* 
	*/
	public CompletableFuture<ExportFuncionarioOutput> exportFuncionarioRequest(ExportFuncionarioInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportFuncionarioOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
