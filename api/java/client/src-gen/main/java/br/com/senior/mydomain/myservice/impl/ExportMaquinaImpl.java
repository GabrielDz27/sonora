...
import br.com.senior.mydomain.myservice.ExportMaquinaInput;
import br.com.senior.mydomain.myservice.ExportMaquinaOutput;
 ...
 * 
 */
public class ExportMaquinaImpl {
	...
	public ExportMaquinaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportMaquinaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.EXPORT_MAQUINA, //
	...
	*/
	public ExportMaquinaOutput exportMaquina(ExportMaquinaInput input, long timeout) {
		...
		ExportMaquinaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportMaquinaOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<ExportMaquinaOutput> exportMaquinaRequest(ExportMaquinaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportMaquinaOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<ExportMaquinaOutput> exportMaquinaRequest(ExportMaquinaInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportMaquinaOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
