...
import br.com.senior.mydomain.myservice.ExportPecaInput;
import br.com.senior.mydomain.myservice.ExportPecaOutput;
...
public class ExportPecaImpl {
	...
	public ExportPecaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportPecaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.EXPORT_PECA, //
	...
	*/
	public ExportPecaOutput exportPeca(ExportPecaInput input, long timeout) {
		...
		ExportPecaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportPecaOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<ExportPecaOutput> exportPecaRequest(ExportPecaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportPecaOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<ExportPecaOutput> exportPecaRequest(ExportPecaInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportPecaOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
