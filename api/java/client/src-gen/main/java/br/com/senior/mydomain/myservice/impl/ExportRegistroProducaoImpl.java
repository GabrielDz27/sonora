...
import br.com.senior.mydomain.myservice.ExportRegistroProducaoInput;
import br.com.senior.mydomain.myservice.ExportRegistroProducaoOutput;
 ...
 * 
 */
public class ExportRegistroProducaoImpl {
	...
	public ExportRegistroProducaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportRegistroProducaoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.EXPORT_REGISTRO_PRODUCAO, //
	...
	*/
	public ExportRegistroProducaoOutput exportRegistroProducao(ExportRegistroProducaoInput input, long timeout) {
		...
		ExportRegistroProducaoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportRegistroProducaoOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<ExportRegistroProducaoOutput> exportRegistroProducaoRequest(ExportRegistroProducaoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportRegistroProducaoOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<ExportRegistroProducaoOutput> exportRegistroProducaoRequest(ExportRegistroProducaoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportRegistroProducaoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
