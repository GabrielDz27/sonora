 ...
 * 
 */
public class GetMaquinaAtivaImpl {
	...
	public GetMaquinaAtivaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage() {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.GET_MAQUINA_ATIVA, //
				new byte[0]);
		}
	...
	*/
	public GetMaquinaAtivaOutput getMaquinaAtiva(long timeout) {
		...
		GetMaquinaAtivaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), GetMaquinaAtivaOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<GetMaquinaAtivaOutput> getMaquinaAtivaRequest() {
		...
		Message message = createMessage();
		addMessageHeaders(message);
		return serviceRunner.request(message, GetMaquinaAtivaOutput.class);
	}
	...
	*/
	public CompletableFuture<GetMaquinaAtivaOutput> getMaquinaAtivaRequest(long timeout, TimeUnit unit) {
		...
		Message message = createMessage();
		addMessageHeaders(message);
		return serviceRunner.request(message, GetMaquinaAtivaOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
