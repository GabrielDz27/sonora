...
import br.com.senior.mydomain.myservice.GetPecaInput;
import br.com.senior.mydomain.myservice.GetPecaOutput;
...
public class GetPecaImpl {
	...
	public GetPecaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(GetPecaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.GET_PECA, //
	...
	*/
	public GetPecaOutput getPeca(GetPecaInput input, long timeout) {
		...
		GetPecaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), GetPecaOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<GetPecaOutput> getPecaRequest(GetPecaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, GetPecaOutput.class);
	}
	...
	* Trazendo todas pecas conforme o filtro
	*/
	public CompletableFuture<GetPecaOutput> getPecaRequest(GetPecaInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, GetPecaOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
