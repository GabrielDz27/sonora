...
import br.com.senior.mydomain.myservice.ImportFuncionarioInput;
import br.com.senior.mydomain.myservice.ImportFuncionarioOutput;
...
public class ImportFuncionarioImpl {
	...
	private Message createMessage(ImportFuncionarioInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.IMPORT_FUNCIONARIO, //
	...
	* 
	*/
	public CompletableFuture<ImportFuncionarioOutput> importFuncionarioRequest(ImportFuncionarioInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportFuncionarioOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
