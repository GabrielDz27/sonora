...
import br.com.senior.mydomain.myservice.ImportMaquinaInput;
import br.com.senior.mydomain.myservice.ImportMaquinaOutput;
 ...
 * 
 */
public class ImportMaquinaImpl {
	...
	public ImportMaquinaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ImportMaquinaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.IMPORT_MAQUINA, //
	...
	*/
	public ImportMaquinaOutput importMaquina(ImportMaquinaInput input, long timeout) {
		...
		ImportMaquinaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ImportMaquinaOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<ImportMaquinaOutput> importMaquinaRequest(ImportMaquinaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportMaquinaOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<ImportMaquinaOutput> importMaquinaRequest(ImportMaquinaInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportMaquinaOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
