...
public class ListFuncionarioImpl {
	...
	private Message createMessage(Funcionario.PageRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.LIST_FUNCIONARIO, //
	...
	* The 'list' request primitive for the Funcionario entity.
	*/
	public CompletableFuture<Funcionario.PagedResults> listFuncionarioRequest(Funcionario.PageRequest input, long timeout, TimeUnit unit) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Funcionario.PagedResults.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
