...
public class RetrieveFuncionarioImpl {
	...
	private Message createMessage(Funcionario.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.RETRIEVE_FUNCIONARIO, //
	...
	* The 'retrieve' request primitive for the Funcionario entity.
	*/
	public CompletableFuture<Funcionario> retrieveFuncionarioRequest(Funcionario.GetRequest input, long timeout, TimeUnit unit) {
