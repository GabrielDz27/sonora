...
public class RetrievePecaImpl {
	...
	public RetrievePecaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Peca.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.RETRIEVE_PECA, //
	...
	*/
	public Peca retrievePeca(Peca.GetRequest input, long timeout) {
		...
		Peca output = DtoJsonConverter.toDTO(resultMessage.getContent(), Peca.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<Peca> retrievePecaRequest(Peca.GetRequest input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Peca.class);
	}
	...
	* The 'retrieve' request primitive for the Peca entity.
	*/
	public CompletableFuture<Peca> retrievePecaRequest(Peca.GetRequest input, long timeout, TimeUnit unit) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Peca.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
