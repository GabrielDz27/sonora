 ...
 * 
 */
public class RetrieveRegistroProducaoImpl {
	...
	public RetrieveRegistroProducaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(RegistroProducao.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.RETRIEVE_REGISTRO_PRODUCAO, //
	...
	*/
	public RegistroProducao retrieveRegistroProducao(RegistroProducao.GetRequest input, long timeout) {
		...
		RegistroProducao output = DtoJsonConverter.toDTO(resultMessage.getContent(), RegistroProducao.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<RegistroProducao> retrieveRegistroProducaoRequest(RegistroProducao.GetRequest input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, RegistroProducao.class);
	}
	...
	* The 'retrieve' request primitive for the RegistroProducao entity.
	*/
	public CompletableFuture<RegistroProducao> retrieveRegistroProducaoRequest(RegistroProducao.GetRequest input, long timeout, TimeUnit unit) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, RegistroProducao.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
