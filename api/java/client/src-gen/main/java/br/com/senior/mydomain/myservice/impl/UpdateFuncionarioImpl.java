...
public class UpdateFuncionarioImpl {
	...
	private Message createMessage(Funcionario input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_FUNCIONARIO, //
	...
	* The 'update' request primitive for the Funcionario entity.
	*/
	public CompletableFuture<Funcionario> updateFuncionarioRequest(Funcionario input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
