 ...
 * 
 */
public class UpdateMaquinaImpl {
	...
	public UpdateMaquinaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Maquina input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_MAQUINA, //
	...
	* The 'update' request primitive for the Maquina entity.
	*/
	public CompletableFuture<Maquina> updateMaquinaRequest(Maquina input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
