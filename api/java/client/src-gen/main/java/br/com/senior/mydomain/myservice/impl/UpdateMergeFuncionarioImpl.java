...
public class UpdateMergeFuncionarioImpl {
	...
	private Message createMessage(Funcionario input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_MERGE_FUNCIONARIO, //
	...
	* The 'updateMerge' request primitive for the Funcionario entity.
	*/
	public CompletableFuture<Funcionario> updateMergeFuncionarioRequest(Funcionario input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
