 ...
 * 
 */
public class UpdateMergeMaquinaImpl {
	...
	public UpdateMergeMaquinaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Maquina input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.UPDATE_MERGE_MAQUINA, //
	...
	* The 'updateMerge' request primitive for the Maquina entity.
	*/
	public CompletableFuture<Maquina> updateMergeMaquinaRequest(Maquina input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
