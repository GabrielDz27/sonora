 ...
 * 
 */
public class UpdateMergePecaImpl {
	...
	public UpdateMergePecaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Peca input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_MERGE_PECA, //
	...
	* The 'updateMerge' request primitive for the Peca entity.
	*/
	public CompletableFuture<Peca> updateMergePecaRequest(Peca input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
