 ...
 * 
 */
public class UpdateMergeRegistroProducaoImpl {
	...
	public UpdateMergeRegistroProducaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(RegistroProducao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.UPDATE_MERGE_REGISTRO_PRODUCAO, //
	...
	* The 'updateMerge' request primitive for the RegistroProducao entity.
	*/
	public CompletableFuture<RegistroProducao> updateMergeRegistroProducaoRequest(RegistroProducao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
