 ...
 * 
 */
public class UpdateMergeRegistro_producaoImpl {
	...
	public UpdateMergeRegistro_producaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Registro_producao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.UPDATE_MERGE_REGISTROPRODUCAO, //
	...
	* The 'updateMerge' request primitive for the Registro_producao entity.
	*/
	public CompletableFuture<Registro_producao> updateMergeRegistro_producaoRequest(Registro_producao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
