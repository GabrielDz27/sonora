...
public class UpdatePecaImpl {
	...
	public UpdatePecaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Peca input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_PECA, //
	...
	* The 'update' request primitive for the Peca entity.
	*/
	public CompletableFuture<Peca> updatePecaRequest(Peca input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
