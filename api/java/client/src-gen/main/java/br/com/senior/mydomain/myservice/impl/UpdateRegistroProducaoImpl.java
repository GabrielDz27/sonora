 ...
 * 
 */
public class UpdateRegistroProducaoImpl {
	...
	public UpdateRegistroProducaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(RegistroProducao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_REGISTRO_PRODUCAO, //
	...
	* The 'update' request primitive for the RegistroProducao entity.
	*/
	public CompletableFuture<RegistroProducao> updateRegistroProducaoRequest(RegistroProducao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
