 ...
 * 
 */
public class UpdateRegistro_producaoImpl {
	...
	public UpdateRegistro_producaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Registro_producao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_REGISTROPRODUCAO, //
	...
	* The 'update' request primitive for the Registro_producao entity.
	*/
	public CompletableFuture<Registro_producao> updateRegistro_producaoRequest(Registro_producao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
