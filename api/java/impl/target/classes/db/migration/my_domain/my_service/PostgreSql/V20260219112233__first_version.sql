/* Database: PostgreSql. Generation date: 2026-02-19 13:52:47:862 */
/* Entity Peca */
create table peca (
	id UUID NOT NULL,
...
alter table registro_producao add constraint fkj8ht0kntf9mwhbcwbflejj6wicoe foreign key (peca) references peca (id);
alter table registro_producao add constraint fkdib67sjspccsxtmgylqnjqbjbtlm foreign key (funcionario) references funcionario (id);
alter table registro_producao add constraint fkxshsmzb2zajtrn76xigjiw5fb204 foreign key (maquina) references maquina (id);
