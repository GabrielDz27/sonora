...
public class AdicaoInput {
     ...
     */
    public AdicaoInput(Double numero1, Double numero2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AdicaoInput)) {
            return false;
        }
        AdicaoInput other = (AdicaoInput) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	AdicaoInputStringSerializer.INSTANCE.serialize(this, sb, appended);
    }
