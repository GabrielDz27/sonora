...
public class CadastrarConvidadoOutput {
    ...
    @Valid
    public RetornoCadastrarConvidado convidado;
    
    @NotNull(message = "resultado is required")
    public TipoSituacao resultado;
     ...
     */
    public CadastrarConvidadoOutput(RetornoCadastrarConvidado convidado, TipoSituacao resultado) {
