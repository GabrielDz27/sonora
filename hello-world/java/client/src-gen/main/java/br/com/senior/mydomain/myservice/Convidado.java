...
public class Convidado extends CustomDTO {
     ...
     */
    public Convidado(String id, String nome, String nomeSocial, String cpf, java.time.LocalDate dataNascimento, List<JsonPatch> jsonPatches) {
        this.id = id;
        this.nome = nome;
     ...
     */
    public Convidado(String nome, String cpf, java.time.LocalDate dataNascimento) {
        this.nome = nome;
        this.cpf = cpf;
        this.dataNascimento = dataNascimento;
    }
