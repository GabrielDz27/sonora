...
public class ConvidadoStringSerializer {
	...
	protected void serializeDataNascimento(Convidado convidado, StringBuilder sb) {
		sb.append("dataNascimento=").append(convidado.dataNascimento == null ? "null" : convidado.dataNascimento);
	}
}
