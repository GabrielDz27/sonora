...
public class DivisaoInput {
     ...
     */
    public DivisaoInput(Double numero1, Double numero2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DivisaoInput)) {
            return false;
        }
        DivisaoInput other = (DivisaoInput) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	DivisaoInputStringSerializer.INSTANCE.serialize(this, sb, appended);
    }
