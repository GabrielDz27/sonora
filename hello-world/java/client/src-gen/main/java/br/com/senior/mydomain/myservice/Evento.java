...
public class Evento extends CustomDTO {
     ...
     */
    public Evento(String id, String nome, Long lotacaoMaxima, java.time.Instant dataHora, String endereco, TipoEntrada tipoentradaevento, java.util.List<Ingresso> ingressos, List<JsonPatch> jsonPatches) {
        this.id = id;
        this.nome = nome;
