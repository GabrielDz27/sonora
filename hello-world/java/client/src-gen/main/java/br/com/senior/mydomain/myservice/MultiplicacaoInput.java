...
public class MultiplicacaoInput {
    ...
    public MultiplicacaoInput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public MultiplicacaoInput(Double numero1, Double numero2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MultiplicacaoInput)) {
            return false;
        }
        MultiplicacaoInput other = (MultiplicacaoInput) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	MultiplicacaoInputStringSerializer.INSTANCE.serialize(this, sb, appended);
    }
