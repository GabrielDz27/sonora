...
public class RetornoCadastrarEvento extends MensagemRetornoComCodigo {
    ...
    @NotNull(message = "tipoEntradaEvento is required")
     ...
     */
    public RetornoCadastrarEvento(String mensagemretorno, String codigoCadastrado, Boolean contemErro, String nome, Boolean apenasColaboradores, Long lotacaoMaxima, java.time.LocalDate data, TipoEntrada tipoEntradaEvento) {
     ...
     */
    public RetornoCadastrarEvento(String mensagemretorno, String codigoCadastrado, String nome, Long lotacaoMaxima, java.time.LocalDate data, TipoEntrada tipoEntradaEvento) {
        this.mensagemretorno = mensagemretorno;
        this.codigoCadastrado = codigoCadastrado;
        this.nome = nome;
        this.lotacaoMaxima = lotacaoMaxima;
