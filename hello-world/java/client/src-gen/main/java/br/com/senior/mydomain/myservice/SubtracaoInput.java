...
public class SubtracaoInput {
    ...
    public SubtracaoInput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public SubtracaoInput(Double numero1, Double numero2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SubtracaoInput)) {
            return false;
        }
        SubtracaoInput other = (SubtracaoInput) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	SubtracaoInputStringSerializer.INSTANCE.serialize(this, sb, appended);
    }
