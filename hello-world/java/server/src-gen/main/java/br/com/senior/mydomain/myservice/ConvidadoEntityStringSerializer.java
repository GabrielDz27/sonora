...
public class ConvidadoEntityStringSerializer {
    ...
    public void serialize(ConvidadoEntity convidado, StringBuilder sb, List<Object> appended) {
		...
		sb.append(", ");
		serializeDataNascimento(convidado, sb);
		sb.append(", ").append(", ");
		sb.append(']');
	}
	...
	protected void serializeDataNascimento(ConvidadoEntity convidado, StringBuilder sb) {
		sb.append("dataNascimento=").append(convidado.getDataNascimento() == null ? "null" : convidado.getDataNascimento());
	}
}
