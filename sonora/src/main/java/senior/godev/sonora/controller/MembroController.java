...
class MembroController {
  ...
  /**
   * @Membros Listar o membro pelo login
   */
  @GetMapping("/login/{login}")
  public ResponseEntity detalharLogin(@PathVariable String login) {
    return ResponseEntity.ok(membroService.detalharMembroPorLogin(login));
  }
}
